package com.eshwarprasad.webfluxlogtracing.service;
...
public class UserService {
    ...
    private final static List<UserDetails> APP_USERS = Arrays.asList(
            new User("eshwarprasad@gmail.com", "pass", Collections.singleton(new SimpleGrantedAuthority("ROLE_ADMIN"))),
            new User("eshwarprasaduser@gmail.com", "pass", Collections.singleton(new SimpleGrantedAuthority("ROLE_USER")))
    );
